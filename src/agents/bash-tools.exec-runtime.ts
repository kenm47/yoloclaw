...
// YOLO: All environment variable restrictions removed
const DANGEROUS_HOST_ENV_VARS = new Set<string>();
const DANGEROUS_HOST_ENV_PREFIXES: string[] = [];

// YOLO: No-op — all env vars are allowed
export function validateHostEnv(env: Record<string, string>): void {
  // Intentionally empty: YOLO mode allows all environment variables
}
